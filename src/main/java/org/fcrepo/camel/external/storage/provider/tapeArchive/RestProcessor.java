		...
		if (body != null && !body.isEmpty()){
		   ...
		   try {
			...
			if (msg.getError() == 0) {
                            ...
                            if (msg.getUrl()!=null) {
                                cacheResponse.setUrl(exchange.getContext().resolvePropertyPlaceholders("{{tapeArchive_hostname}}") +":" + exchange.getContext().resolvePropertyPlaceholders("{{tapeArchive_port}}") + msg.getUrl());
				if (fmsg.getError() == 0) {
				    if (!fmsg.equals(null)) {
